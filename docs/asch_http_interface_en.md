...
- [Asch-HTTP Interface Specification](#asch-http-interface-specification)
  ...
  - [2 Interface](#2-interface)
    ...
    - [2.10 Register Publisher](#210-register-publisher)
      - [2.10.1 Create Transaction](#2101-create-transaction)
    - [2.11 Issue Asset](#211-issue-asset)
      - [2.11.1 Create Transaction](#2111-create-transaction)
    - [2.12 Create Asset](#212-create-asset)
      - [2.12.1 Create Transaction](#2121-create-transaction)
...
### 2.10 Register Publisher  
#### 2.10.1 Create Transaction

Request Parameter Description: 

|Name	|Type   |Required |Description              |   
|------ |-----  |---  |----              |   
|transaction|json|Y|transaction data generated by `asch-js.uia.createIssuer`|
...
{
  "success": true,
  "transactionId": "a58ac0438398b836e6f6862c744c23e7c071be1b006f1c533bf22bbc1cba118f"
}
```
...
### 2.11 Issue Asset  
#### 2.11.1 Create Transaction

Request Parameter Description: 

|Name	|Type   |Required |Description              |   
|------ |-----  |---  |----              |   
|transaction|json|Y|transaction data generated by `asch-js.uia.createAsset`|
...
{
  "success": true,
  "transactionId": "c63ac0438398b836e6f6862c744c23e7c071be1b006f1c533bf22bbc1cba118f"
}
```
...
|Name	|Type   |Required |Description              |   
|------ |-----  |---  |----              |   
|transaction|json|Y|transaction data generated by `asch-js.uia.createIssue`|
...
let amount = '10000000'
let password = 'measure bottom stock hospital calm hurdle come banner high edge foster cram'
...
All the writing operations in Asch system are finished by starting a transaction.
The transaction data is generated through a JS library named [asch-js](http://github.com/AschPlatform/asch-js), and then broadcasted by a POST API.
